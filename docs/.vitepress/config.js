                    ...
                    items: [
                        ...
                        { text: '1.项目搭建', link: '/vuePage/vue3源码/01-项目搭建/1.项目搭建' },
                        {
                            ...
                            items: [
                                ...
                                { text: '2.链表', link: '/vuePage/vue3源码/02-reactivity/2.链表' },
                                { text: '3.链表的应用', link: '/vuePage/vue3源码/02-reactivity/3.链表的应用' },
                                { text: '4.reactiveEffect', link: '/vuePage/vue3源码/02-reactivity/4.reactiveEffect' },
                                { text: '5.dep和sub之间的双向连接', link: '/vuePage/vue3源码/02-reactivity/5.dep和sub之间的双向连接' },
                                { text: '6.分支切换', link: '/vuePage/vue3源码/02-reactivity/6.分支切换'},
                                { text: '7.reactive实现原理', link: '/vuePage/vue3源码/02-reactivity/7.reactive实现原理'},
                                { text: '8.computed', link: '/vuePage/vue3源码/02-reactivity/8.computed'},
                                { text: '9.watch', link: '/vuePage/vue3源码/02-reactivity/9.watch'},
                        ...
                        { text: '3.浏览器运行时：runtime-dom', link: '/vuePage/vue3源码/03-浏览器运行时/1.浏览器运行时-runtime-dom' },
                        {
                            ...
                            items: [
                                ...
                                { text: '4.createApp',  link: '/vuePage/vue3源码/04-核心运行时/4.createApp'},
                                {
                                    text: '5.组件',
                                    collapsed: true,
                                    items: [
