import{_ as s,o as n,c as a,O as e}from"./chunks/framework.f59a8fe5.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"otherThing/个人网站申请ssl证书，配置https.md","filePath":"otherThing/个人网站申请ssl证书，配置https.md","lastUpdated":1703473821000}'),l={name:"otherThing/个人网站申请ssl证书，配置https.md"},p=e(`<h2 id="一、申请证书" tabindex="-1">一、申请证书 <a class="header-anchor" href="#一、申请证书" aria-label="Permalink to &quot;一、申请证书&quot;">​</a></h2><p>人域名是在腾讯云买的，直接在腾讯云申请证书。<br> 选择域名免费版。<br> 按照提示填写相应的域名信息。<br> 证书签发成功后，点击下载，把证书下载到本地。<br></p><h2 id="二、证书安装" tabindex="-1">二、证书安装 <a class="header-anchor" href="#二、证书安装" aria-label="Permalink to &quot;二、证书安装&quot;">​</a></h2><p>nginx安装方法：</p><ol><li>把下载的证书文件解压后，<code>nginx</code>文件夹下的证书文件和私钥文件拷贝到<code>nginx</code>的目录下<code>/usr/local/nginx/conf</code>。 文件要和<code>nginx.conf</code>的配置文件在同一目录下。</li><li>修改<code>nginx.conf</code>文件，增加一下内容</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">server {</span></span>
