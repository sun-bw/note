import{_ as s,o as a,c as n,V as l}from"./chunks/framework.39adc7c5.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"dockerPage/5.docker云端部署spring boot+vue项目.md","filePath":"dockerPage/5.docker云端部署spring boot+vue项目.md","lastUpdated":1717654037000}'),e={name:"dockerPage/5.docker云端部署spring boot+vue项目.md"},o=l(`<h2 id="一、购买服务器-域名" tabindex="-1">一、购买服务器，域名 <a class="header-anchor" href="#一、购买服务器-域名" aria-label="Permalink to &quot;一、购买服务器，域名&quot;">​</a></h2><p>购买服务器，域名，域名备案。服务器创建centos系统</p><h2 id="二、安装docker以及必备软件" tabindex="-1">二、安装docker以及必备软件 <a class="header-anchor" href="#二、安装docker以及必备软件" aria-label="Permalink to &quot;二、安装docker以及必备软件&quot;">​</a></h2><ul><li>docker安装</li><li>mysql安装</li><li>nginx安装</li></ul><h2 id="三、制作centos7-jdk11镜像-使用yum安装" tabindex="-1">三、制作centos7 + jdk11镜像（使用yum安装） <a class="header-anchor" href="#三、制作centos7-jdk11镜像-使用yum安装" aria-label="Permalink to &quot;三、制作centos7 + jdk11镜像（使用yum安装）&quot;">​</a></h2><ol><li>在root下建立Dockerfile：<code>vim Dockerfile</code>(rm -rf Dockerfile删除)</li><li>写入内容：<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">#使用的基础镜像</span></span>
